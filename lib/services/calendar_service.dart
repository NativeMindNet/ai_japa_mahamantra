...
class CalendarService {
  ...
  static Future<List<Map<String, dynamic>>> getEventsForWeek(
    DateTime weekStart,
  ) async {
  ...
  static Future<Map<String, dynamic>> getEventsStatistics() async {
    try {
      ...
      return {
        ...
        'averageRounds': events.isNotEmpty
            ? (totalRounds / events.length).round()
            : 0,
        'averageDuration': events.isNotEmpty
            ? (totalDuration / events.length).round()
            : 0,
